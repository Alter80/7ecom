...
//     <Box>Already have an account?<br /><Link to='/login' style={{ color: '#333' }}>Login</Link></Box> :
//     <Box>Don't have an account?<br /><Link to='/register' style={{ color: '#333' }}>Create an account</Link></Box>;
...
//   return (
//     <Box>
//       <Box sx={{ border: '1px solid #333', borderRadius: '10px', p: 5 }}>
//         <Typography component="h2" variant="h4" sx={{ pb: 1, color: '#122136' }}>{handleLoginText}</Typography>
//         <Box sx={{ height: '1px', width: '30%', bgcolor: '#c61932' }}></Box>
