...
import { Avatar, Box, Button, Container, Divider, IconButton, Menu, MenuItem, Tooltip, useMediaQuery } from '@mui/material';
...
const Header = () => {
  ...
  return (
    <Box sx={{ position: 'sticky', top: 0, zIndex: 1100 }}>
      <Container maxWidth="xl" sx={{color: 'black', bgcolor: '#f8f8f8'}}>
